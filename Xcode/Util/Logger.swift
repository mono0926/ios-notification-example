...
public struct Logger {
    ...
    fileprivate init(subsystem: String) {
        self.log = OSLog(subsystem: subsystem, category: "default")
    }
...
public let logger = Logger(subsystem: "com.mono0926.notification.example")
